...
},{"./src/root.jsx":177,"react":171}],2:[function(require,module,exports){
...
var React=require("react"),Router=require("react-router-component"),Locations=Router.Locations,Location=Router.Location,NotFound=Router.NotFound,Head=require("./head.jsx"),Header=require("./header.jsx"),Home=require("./home.jsx"),About=require("./about.jsx"),NotFoundPage=require("./not-found-page.jsx"),Root=React.createClass({displayName:"Root",statics:{getRoutes:function(){return[{path:"/",handler:Home},{path:"/about",handler:About}]},renderToString:function(e){var t="<!DOCTYPE html>";return t+=React.renderToString(React.createElement(Root,React.__spread({},e)))}},render:function(){var e={__html:"window.INITIAL_PROPS = "+JSON.stringify(this.props)+";\n"},t=this.props.script;return React.createElement("html",null,React.createElement(Head,React.__spread({},this.props)),React.createElement("body",null,React.createElement(Header,null),React.createElement(Locations,{path:this.props.path},React.createElement(Location,{path:"/",handler:Home}),React.createElement(Location,{path:"/about",handler:About}),React.createElement(NotFound,{handler:NotFoundPage})),React.createElement("script",{dangerouslySetInnerHTML:e}),React.createElement("script",{src:t})))}});module.exports=Root;


},{"./about.jsx":172,"./head.jsx":173,"./header.jsx":174,"./home.jsx":175,"./not-found-page.jsx":176,"react":171,"react-router-component":5}]},{},[1]);
