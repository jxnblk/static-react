...
var React=require("react"),Root=React.createFactory(require("./src/root.jsx"));React.render(Root(window.INITIAL_PROPS),document);


},{"./src/root.jsx":178,"react":171}],2:[function(require,module,exports){
...
},{"react":171,"react-router-component":5}],175:[function(require,module,exports){
...
var React=require("react"),Head=React.createClass({displayName:"Head",render:function(){return React.createElement("head",null,React.createElement("meta",{charSet:"utf-8"}),React.createElement("title",null,this.props.title),React.createElement("meta",{name:"viewport",content:"width=device-width,initial-scale=1.0"}),React.createElement("link",{rel:"stylesheet",href:this.props.stylesheet}))}});module.exports=React.createClass({displayName:"exports",render:function(){var e={__html:"window.INITIAL_PROPS = "+JSON.stringify(this._owner.props)+";\n"};return React.createElement("html",null,React.createElement(Head,React.__spread({},this.props)),React.createElement("body",null,this.props.children,React.createElement("script",{dangerouslySetInnerHTML:e}),React.createElement("script",{src:this.props.script})))}});
...
var React=require("react"),Router=require("react-router-component"),Locations=Router.Locations,Location=Router.Location,NotFound=Router.NotFound,Layout=require("./layout.jsx"),Head=require("./head.jsx"),Header=require("./header.jsx"),Home=require("./home.jsx"),About=require("./about.jsx"),NotFoundPage=require("./not-found-page.jsx"),Root=React.createClass({displayName:"Root",statics:{getRoutes:function(){return[{path:"/",handler:Home},{path:"/about",handler:About}]},renderToString:function(e){var t="<!DOCTYPE html>";return t+=React.renderToString(React.createElement(Root,React.__spread({},e)))}},render:function(){return React.createElement(Layout,React.__spread({},this.props),React.createElement(Header,null),React.createElement(Locations,{path:this.props.path},React.createElement(Location,{path:"/",handler:Home}),React.createElement(Location,{path:"/about",handler:About}),React.createElement(NotFound,{handler:NotFoundPage})))}});module.exports=Root;


},{"./about.jsx":172,"./head.jsx":173,"./header.jsx":174,"./home.jsx":175,"./layout.jsx":176,"./not-found-page.jsx":177,"react":171,"react-router-component":5}]},{},[1]);
